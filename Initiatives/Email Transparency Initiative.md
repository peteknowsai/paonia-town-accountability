...
**Status:** Submitted September 3, 2025 (omnibus)
**Version:** v1

## Summary
Requires preservation of electronic communication system audit logs for 3 years. Makes audit logs public records under CORA. Prohibits disabling or destroying audit logging.

## Why It's Needed
Town claims M365 audit logs "don't exist" — technically impossible. M365 generates them automatically and they cannot be fully disabled.
...
(c) **"Town business"** means any communication or activity relating to public duties, regardless of device or account used.
...
(d) Nothing in this ordinance limits any remedies available under CORA or other applicable law.
...
These logs already exist. This just ensures they're preserved and available for public oversight.
